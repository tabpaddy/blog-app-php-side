...
<?php elseif(isset($_SESSION['edit-category-success'])): // show if edit user was successful?>
            <div class="alert__message success container">
                <p>
                    <?= 
...
<?php elseif(isset($_SESSION['edit-category'])): // show if edit user was not successful?>
            <div class="alert__message error container">
                <p>
                    <?= 
...
<?php elseif(isset($_SESSION['delete-category-success'])): // show if delete message is successful?>
            <div class="alert__message success container">
                <p>
                    <?= 
