...
$query = "SELECT posts.id, posts.title, posts.category_id FROM posts JOIN users ON posts.author_id = users.user_id WHERE posts.author_id=$current_user_id ORDER BY posts.id DESC";
